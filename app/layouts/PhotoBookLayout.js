            ...
            {!user ? (
                ...
                <>
                    ...
                    <div className="lg:pl-56 bg-white w-full overflow-x-scroll">
                        <div className="fixed w-full top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white shadow-sm pr-5 right-0">
                            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-end">
                                <button onClick={() => setSaveProject(true)} className="flex items-center space-x-2 px-1 group absolute left-[15rem] bottom-5">
                                    <svg className="h-6 w-6 stroke-blue-500 group-hover:stroke-blue-400" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <h3 className="text-black group-hover:text-blue-400 text-sm font-semibold">{projectId ? 'Update' : 'Save'}</h3>
                                </button>
