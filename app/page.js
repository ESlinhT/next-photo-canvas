...
export default function Home() {
    return (
        <BlueBackgroundLayout>
            <div className="mx-auto max-w-7xl min-h-[100vh] px-6 lg:flex lg:flex-row pt-4 lg:pt-0 lg:px-8 sm:flex sm:flex-col justify-center items-center">
                <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                    ...
                    <div className="mt-4 lg:mt-10 flex items-center gap-x-6">
                        <Link
                ...
                <div
                    className="mx-auto mt-4 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
                    <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                        <Image
                            ...
                            width={540}
                            height={540}
                            className="w-[76rem] bg-white/5 shadow-2xl ring-1 ring-white/10 max-w-xs lg:max-w-[540px]"
                        />
                    </div>
                </div>
            </div>
