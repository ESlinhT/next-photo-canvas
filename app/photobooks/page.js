                    ...
                    <div className="lg:pl-56 bg-white w-full overflow-x-scroll">
                        <div
                            ...
                            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-end">
                                <button onClick={() => setSaveProject(true)} className="flex items-center space-x-2 px-1 group">
                                    ...
                                    <h3 className="text-slate-900 group-hover:text-blue-400 text-xs font-semibold">Save</h3>
                                </button>
